            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                    <span
                        ...
                        Teachr<span className="text-orange-500">'</span>Shop</span>
                </a>
                ...
                <div className="justify-items-center hidden w-full md:flex md:w-auto md:order-1"
                     id="navbar-cta">
                    <ul className="bg-sky-900 flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
                        <li>
                            <Link to="/hubP"
